...
class LineResults(Results):
    ...
    def add_line_values(self, line_values):
        self.line_values_dict[self.current_line_values_list_id] = \
            [[line_to_unit_interval(line[0], self.line_start, self.line_end), line[1]] for line in line_values]
    ...
    def combined_line_value_generator(self):
        ...
        while True:
            ...
            yield line_embedding(min_unit, self.line_start, self.line_end), k_min_values
